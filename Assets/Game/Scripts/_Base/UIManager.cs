...
public class UIManager : MonoBehaviour
{
    ...
    [SerializeField] public Image [] kalpler;
    [SerializeField] private TextMeshProUGUI MamaText;
    ...
    public void UpdateMamaText()
    {
        MamaText.text = GameManager.Instance.spoon.takenMamas.ToString();
        puanText.text = "Puan : " + GameManager.Instance.actor.GetComponent<PlayerController>().puan;
    }
    public void UpdateCanText()
    {
        kalpler[GameManager.Instance.playerChances].sprite = bosKalpImage;
    }
    ...
    void Update()
    {
        ...
        UpdateProgressBar(GameManager.Instance.actor.position.z,0.4f);
    }
